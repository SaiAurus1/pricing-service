"""
Django settings for pricing service - Railway deployment version.
"""
...
INSTALLED_APPS = [
    ...
    'pricing.apps.PricingConfig',  # Only pricing app
    'rest_framework',
    'corsheaders',
]
...
ROOT_URLCONF = 'pricing_service.urls'
...
# CORS settings - Allow main docAnalysis service and frontend
